  ...
  return (
    <section className="relative overflow-hidden px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="absolute inset-0 bg-white sm:bg-gradient-to-b sm:from-white sm:via-[#f4f7fc] sm:to-white" />
        <div className="absolute left-1/2 top-20 hidden h-[30rem] w-[48rem] -translate-x-1/2 rounded-full bg-[#0057ff]/[0.07] blur-3xl sm:block" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mx-auto mt-6 max-w-3xl sm:mt-8">
          {current && (
            <article
              key={current.year}
              className="animate-[who-card-in_0.45s_ease-out] overflow-hidden rounded-none border-0 bg-transparent shadow-none sm:rounded-[1.75rem] sm:border sm:border-[#d7e4f5] sm:bg-white sm:shadow-[0_30px_80px_rgba(0,87,255,0.12)]"
            >
              <div className="flex items-center justify-between gap-3 rounded-[1rem] bg-gradient-to-r from-[#0057ff] to-[#00a8ff] px-4 py-3.5 sm:rounded-none sm:gap-4 sm:px-8 sm:py-4">
                <div>
              ...
              <div className="relative px-1 py-4 sm:px-8 sm:py-8">
                <div className="pointer-events-none absolute -right-16 top-0 hidden h-40 w-40 rounded-full bg-accent/[0.07] blur-2xl sm:block" />
